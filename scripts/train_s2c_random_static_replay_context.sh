...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS2c_temporal3_random_static_replay_context \
  ...
  --env.quadrotor.seed 35500 --env.quadrotor.max_steps 300 \
