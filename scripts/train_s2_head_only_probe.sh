...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS2_head_only_probe_125 \
  ...
  --agent.loss_scales.dyn 0 --agent.loss_scales.rep 0 \
  --agent.loss_scales.rec 0 --agent.loss_scales.policy 0 \
  ...
  --logger.outputs jsonl --logger.filter 'loss/(rew|con)|opt/' \
