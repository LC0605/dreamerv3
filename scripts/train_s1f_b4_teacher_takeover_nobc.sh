...
latest=$(tr -d '\n' < outputs/dreamerv3/stageS1fB3_temporal3_teacher_takeover_lowbc/ckpt/latest)
source_checkpoint="outputs/dreamerv3/stageS1fB3_temporal3_teacher_takeover_lowbc/ckpt/$latest"

exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS1fB4_temporal3_teacher_takeover_nobc \
  ...
  --logger.outputs jsonl --logger.filter 'loss/|opt/' \
