...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS2a_temporal3_random_static_model_critic \
  ...
  --agent.loss_scales.policy 0 --agent.opt.lr 0.000001 --agent.opt.warmup 0 \
  ...
  --env.quadrotor.seed 35100 --env.quadrotor.max_steps 300 \
