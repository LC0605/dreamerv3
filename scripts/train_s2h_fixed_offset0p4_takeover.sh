...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS2h_fixed_offset0p4_takeover \
  --configs quadrotor --script bc_distill \
  --run.from_checkpoint outputs/dreamerv3/stageS2h_fixed_offset0p4_actor_bc/ckpt/20260826T081209F667115 \
