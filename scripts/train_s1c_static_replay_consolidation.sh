...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS1c_temporal3_static_replay_consolidation \
  --configs quadrotor \
  ...
  --env.quadrotor.obstacle_count 1 --env.quadrotor.obstacle_spawn_probability 0.6 \
