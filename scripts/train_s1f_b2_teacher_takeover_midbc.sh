...
latest=$(tr -d '\n' < outputs/dreamerv3/stageS1fB1_temporal3_teacher_takeover_short/ckpt/latest)
source_checkpoint="outputs/dreamerv3/stageS1fB1_temporal3_teacher_takeover_short/ckpt/$latest"

exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS1fB2_temporal3_teacher_takeover_midbc \
  ...
  --agent.bc_only False --agent.bc_scale 0.3 --agent.bc_fixed_std 0.3 \
