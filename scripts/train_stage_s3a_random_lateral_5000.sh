...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS3A_random_lateral_5000 \
  ...
  --run.bc_dataset outputs/dreamerv3/stageS3A_joint_replay \
  --run.bc_updates 5000 --run.bc_validate_every 1000 \
