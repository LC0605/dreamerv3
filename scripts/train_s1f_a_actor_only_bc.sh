...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS1fA_temporal3_actor_only_bc \
  ...
  --run.bc_updates 100 --run.bc_validate_every 25 \
  --batch_size 8 --batch_length 301 --report_length 301 --replay_context 0 \
  --agent.bc_only True --agent.bc_scale 1.0 \
  ...
  --env.quadrotor.obstacle_count 1 --env.quadrotor.obstacle_spawn_probability 1 \
