...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS1fA3_temporal3_actor_mean_bc \
  ...
  --run.bc_updates 1000 --run.bc_validate_every 100 --run.bc_fixed_train False \
  ...
  --agent.opt.lr 0.0001 --agent.opt.warmup 0 \
