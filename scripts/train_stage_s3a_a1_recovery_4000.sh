...
exec /home/user/miniconda3/envs/dreamer_uav/bin/python dreamerv3/dreamerv3/main.py \
  --logdir outputs/dreamerv3/stageS3A_A1_Recovery_4000 \
  --configs quadrotor --script bc_distill \
  --run.from_checkpoint outputs/dreamerv3/stageS3A_Retry_A1_4000/ckpt/20260830T121605F166990 \
  --run.from_checkpoint_regex '.*' \
  --run.bc_dataset outputs/dreamerv3/stageS3A_A1_Recovery_replay \
